...
import io.kokoichi.sample.cleanarchitecture.feature_note.data.repository.FakeNoteRepository
...
class GetNotesTest {
    ...
    @Test
    fun `Order color by color descending, correct order`() = runBlocking {
