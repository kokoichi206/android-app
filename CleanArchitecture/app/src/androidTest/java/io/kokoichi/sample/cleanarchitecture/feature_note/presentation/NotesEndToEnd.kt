package io.kokoichi.sample.cleanarchitecture.feature_note.presentation
...
import io.kokoichi.sample.cleanarchitecture.MainActivity
import io.kokoichi.sample.cleanarchitecture.core.util.TestTags
import io.kokoichi.sample.cleanarchitecture.feature_note.di.AppModule
import io.kokoichi.sample.cleanarchitecture.feature_note.presentation.add_edit_note.AddEditNoteScreen
import io.kokoichi.sample.cleanarchitecture.feature_note.presentation.notes.NotesScreen
...
class NotesEndToEnd {
    ...
    fun saveNewNote_editAfterwards() {
        ...
        // Make sure  title and content texit fields contain note title and content
        composeRule
            .onNodeWithTag(TestTags.TITLE_TEXT_FIELD)
